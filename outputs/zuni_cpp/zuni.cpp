...
void Num2Bits_32_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Num2Bits_32_run(uint ctx_index,Circom_CalcWit* ctx);
...
void Num2Bits_34_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Num2Bits_34_run(uint ctx_index,Circom_CalcWit* ctx);
...
void ZUni_36_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void ZUni_36_run(uint ctx_index,Circom_CalcWit* ctx);
void sqrt_0(Circom_CalcWit* ctx,FrElement* lvar,uint componentFather,FrElement* destination,int destination_size);
Circom_TemplateFunction _functionTable[37] = { 
Num2Bits_0_run,
CompConstant_1_run,
CompConstant_2_run,
AliasCheck_3_run,
...
Num2Bits_35_run,
ZUni_36_run };
Circom_TemplateFunction _functionTableParallel[37] = { 
NULL,
NULL,
NULL,
NULL,
...
uint get_total_signal_no() {return 90741;}

uint get_number_of_components() {return 7853;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 36677;}
...
Num2Bits_0_create(mySignalStart+383,0+ctx_index+1,ctx,new_cmp_name,myId);
...
CompConstant_2_create(mySignalStart+254,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
PFrElement aux_dest = &lvar[0];
...
AliasCheck_3_create(mySignalStart+1031,3+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 3+ctx_index+1;
}
{
std::string new_cmp_name = "b2nY";
Bits2Num_4_create(mySignalStart+1804,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 6+ctx_index+1;
}
{
std::string new_cmp_name = "babyCheck";
BabyCheck_5_create(mySignalStart+2059,7+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 7+ctx_index+1;
}
{
std::string new_cmp_name = "n2bX";
Num2Bits_6_create(mySignalStart+2063,8+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 8+ctx_index+1;
}
{
std::string new_cmp_name = "aliasCheckX";
AliasCheck_3_create(mySignalStart+258,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "signCalc";
CompConstant_7_create(mySignalStart+2318,9+ctx_index+1,ctx,new_cmp_name,myId);
...
MultiMux3_10_create(mySignalStart+58,7+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 7+ctx_index+1;
}
{
std::string new_cmp_name = "dbl2";
MontgomeryDouble_11_create(mySignalStart+52,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 6+ctx_index+1;
}
{
std::string new_cmp_name = "adr3";
MontgomeryAdd_12_create(mySignalStart+10,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "adr4";
MontgomeryAdd_12_create(mySignalStart+17,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "adr5";
MontgomeryAdd_12_create(mySignalStart+24,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "adr6";
MontgomeryAdd_12_create(mySignalStart+31,3+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 3+ctx_index+1;
}
{
std::string new_cmp_name = "adr7";
MontgomeryAdd_12_create(mySignalStart+38,4+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 4+ctx_index+1;
}
{
std::string new_cmp_name = "adr8";
MontgomeryAdd_12_create(mySignalStart+45,5+ctx_index+1,ctx,new_cmp_name,myId);
...
Edwards2Montgomery_9_create(mySignalStart+1135,147+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 147+ctx_index+1;
}
{
uint aux_create = 1;
...
Montgomery2Edwards_14_create(mySignalStart+1139,148+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[198] = 148+ctx_index+1;
}
{
PFrElement aux_dest = &lvar[1];
// load src
...
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 143
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 51);
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 51);
// end load src
...
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 100);
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 100);
// end load src
...
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 149);
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 149);
// end load src
...
{
std::string new_cmp_name = "e2m";
Edwards2Montgomery_9_create(mySignalStart+721,93+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 93+ctx_index+1;
}
{
uint aux_create = 1;
int aux_cmp_num = 95+ctx_index+1;
uint csoffset = mySignalStart+729;
...
uint csoffset = mySignalStart+349;
...
uint csoffset = mySignalStart+535;
uint aux_dimensions[1] = {31};
for (uint i = 0; i < 31; i++) {
std::string new_cmp_name = "doublers2"+ctx->generate_position_array(aux_dimensions, 1, i);
MontgomeryDouble_11_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
...
{
std::string new_cmp_name = "m2e";
Montgomery2Edwards_14_create(mySignalStart+725,94+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[126] = 94+ctx_index+1;
}
{
PFrElement aux_dest = &lvar[1];
// load src
...
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 141
{
uint cmp_index_ref = ((1 * Fr_toInt(&expaux[0])) + 33);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 141
...
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 143
{
uint cmp_index_ref = ((1 * Fr_toInt(&expaux[0])) + 64);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 143
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 33);
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 33);
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 33)]].signalStart + 0]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MontgomeryDouble_11_run(mySubcomponents[cmp_index_ref],ctx);
...
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 33);
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 33)]].signalStart + 1]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MontgomeryDouble_11_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 146
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 64);
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 64);
// end load src
...
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 154
{
uint cmp_index_ref = ((1 * Fr_toInt(&expaux[0])) + 95);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[6]); // line circom 154
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 95);
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 95);
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 95)]].signalStart + 0]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MontgomeryAdd_12_run(mySubcomponents[cmp_index_ref],ctx);
...
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 95);
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 95)]].signalStart + 1]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MontgomeryAdd_12_run(mySubcomponents[cmp_index_ref],ctx);
...
cmp_index_ref_load = 125;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[125]].signalStart + 1]);
}
// need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
...
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 1928;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
Segment_15_create(mySignalStart+2020,9+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 9+ctx_index+1;
}
{
std::string new_cmp_name = "segments[1]";
Segment_15_create(mySignalStart+7963,609+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 609+ctx_index+1;
}
{
std::string new_cmp_name = "segments[2]";
Segment_15_create(mySignalStart+13906,1209+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 1209+ctx_index+1;
}
{
std::string new_cmp_name = "segments[3]";
Segment_15_create(mySignalStart+19849,1809+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 1809+ctx_index+1;
}
{
std::string new_cmp_name = "segments[4]";
Segment_15_create(mySignalStart+25792,2409+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 2409+ctx_index+1;
}
{
std::string new_cmp_name = "segments[5]";
Segment_15_create(mySignalStart+31735,3009+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 3009+ctx_index+1;
}
{
std::string new_cmp_name = "segments[6]";
Segment_15_create(mySignalStart+37678,3609+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 3609+ctx_index+1;
}
{
std::string new_cmp_name = "segments[7]";
Segment_15_create(mySignalStart+43621,4209+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 4209+ctx_index+1;
}
{
std::string new_cmp_name = "segments[8]";
Segment_15_create(mySignalStart+49564,4809+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 4809+ctx_index+1;
}
{
std::string new_cmp_name = "segments[9]";
Segment_16_create(mySignalStart+55507,5409+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 5409+ctx_index+1;
}
{
uint aux_create = 10;
int aux_cmp_num = 0+ctx_index+1;
...
Fr_lt(&expaux[0],&lvar[44],&circuitConstants[48]); // line circom 202
while(Fr_isTrue(&expaux[0])){
{{
Fr_eq(&expaux[0],&lvar[44],&circuitConstants[27]); // line circom 203
}}
if(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[46];
...
// load src
Fr_mul(&expaux[1],&lvar[44],&circuitConstants[50]); // line circom 209
...
Fr_lt(&expaux[0],&lvar[44],&circuitConstants[27]); // line circom 219
while(Fr_isTrue(&expaux[0])){
{{
...
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[44])) + 10);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_sub(&expaux[0],&lvar[44],&circuitConstants[2]); // line circom 227
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 10);
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 10);
// end load src
...
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 10);
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 10)]].signalStart + 1]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
BabyAdd_17_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 4];
// load src
cmp_index_ref_load = ((1 * (Fr_toInt(&lvar[44]) + 1)) + 0);
cmp_index_ref_load = ((1 * (Fr_toInt(&lvar[44]) + 1)) + 0);
// end load src
...
{
std::string new_cmp_name = "n2bX";
Num2Bits_6_create(mySignalStart+1804,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 6+ctx_index+1;
}
{
std::string new_cmp_name = "n2bY";
Num2Bits_6_create(mySignalStart+2059,7+ctx_index+1,ctx,new_cmp_name,myId);
...
{
std::string new_cmp_name = "signCalc";
CompConstant_7_create(mySignalStart+2314,8+ctx_index+1,ctx,new_cmp_name,myId);
...
BabyAdd_17_create(mySignalStart+4,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
MontgomeryDouble_11_create(mySignalStart+16,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "adder";
MontgomeryAdd_12_create(mySignalStart+9,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "selector";
Multiplexor2_22_create(mySignalStart+22,2+ctx_index+1,ctx,new_cmp_name,myId);
...
{
std::string new_cmp_name = "e2m";
Edwards2Montgomery_9_create(mySignalStart+4417,588+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[147] = 588+ctx_index+1;
}
{
std::string new_cmp_name = "m2e";
Montgomery2Edwards_14_create(mySignalStart+4438,591+ctx_index+1,ctx,new_cmp_name,myId);
...
Multiplexor2_22_create(mySignalStart+4431,590+ctx_index+1,ctx,new_cmp_name,myId);
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[52]); // line circom 92
while(Fr_isTrue(&expaux[0])){
{
...
{
std::string new_cmp_name = "e2m";
Edwards2Montgomery_9_create(mySignalStart+3217,428+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[107] = 428+ctx_index+1;
}
{
std::string new_cmp_name = "m2e";
Montgomery2Edwards_14_create(mySignalStart+3238,431+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[108] = 431+ctx_index+1;
}
{
std::string new_cmp_name = "eadder";
BabyAdd_17_create(mySignalStart+3221,429+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[109] = 429+ctx_index+1;
}
{
std::string new_cmp_name = "lastSel";
Multiplexor2_22_create(mySignalStart+3231,430+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[110] = 430+ctx_index+1;
}
{
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[55]); // line circom 92
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 0);
{
...
{
std::string new_cmp_name = "segments[0]";
SegmentMulAny_24_create(mySignalStart+280,3+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 3+ctx_index+1;
}
{
std::string new_cmp_name = "segments[1]";
SegmentMulAny_25_create(mySignalStart+4722,596+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 596+ctx_index+1;
}
{
std::string new_cmp_name = "doublers";
MontgomeryDouble_11_create(mySignalStart+270,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "m2e";
Montgomery2Edwards_14_create(mySignalStart+276,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "adders";
BabyAdd_17_create(mySignalStart+260,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "zeropoint";
IsZero_21_create(mySignalStart+7964,1029+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 1029+ctx_index+1;
}
{
PFrElement aux_dest = &lvar[1];
// load src
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId].defs[2].offset+map_accesses_aux[0]];
// load src
Fr_mul(&expaux[1],&lvar[3],&circuitConstants[51]); // line circom 157
...
// load src
Fr_sub(&expaux[2],&circuitConstants[58],&signalValues[mySignalStart + 258]); // line circom 162
cmp_index_ref_load = 5;
cmp_index_ref_load = 5;
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId].defs[3].offset+map_accesses_aux[0]];
// load src
Fr_sub(&expaux[2],&circuitConstants[59],&signalValues[mySignalStart + 259]); // line circom 163
cmp_index_ref_load = 5;
cmp_index_ref_load = 5;
...
{
std::string new_cmp_name = "mux";
MultiMux3_10_create(mySignalStart+57,7+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 7+ctx_index+1;
}
{
std::string new_cmp_name = "dbl2";
MontgomeryDouble_11_create(mySignalStart+51,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 6+ctx_index+1;
}
{
std::string new_cmp_name = "adr3";
...
{
std::string new_cmp_name = "adr4";
MontgomeryAdd_12_create(mySignalStart+16,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "adr5";
MontgomeryAdd_12_create(mySignalStart+23,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "adr6";
MontgomeryAdd_12_create(mySignalStart+30,3+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 3+ctx_index+1;
}
{
std::string new_cmp_name = "adr7";
MontgomeryAdd_12_create(mySignalStart+37,4+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 4+ctx_index+1;
}
{
std::string new_cmp_name = "adr8";
MontgomeryAdd_12_create(mySignalStart+44,5+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 5+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
{
std::string new_cmp_name = "e2m";
Edwards2Montgomery_9_create(mySignalStart+1437,169+ctx_index+1,ctx,new_cmp_name,myId);
...
MontgomeryDouble_11_create(mySignalStart+1431,168+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[250] = 168+ctx_index+1;
}
{
std::string new_cmp_name = "m2e";
Montgomery2Edwards_14_create(mySignalStart+1441,170+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[251] = 170+ctx_index+1;
}
{
std::string new_cmp_name = "cm2e";
Montgomery2Edwards_14_create(mySignalStart+1427,167+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[252] = 167+ctx_index+1;
}
{
std::string new_cmp_name = "cAdd";
BabyAdd_17_create(mySignalStart+836,83+ctx_index+1,ctx,new_cmp_name,myId);
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[60]); // line circom 166
while(Fr_isTrue(&expaux[0])){
{{
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[61]); // line circom 183
if(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 167);
{
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[60]); // line circom 194
while(Fr_isTrue(&expaux[0])){
{{
...
{
std::string new_cmp_name = "e2m";
Edwards2Montgomery_9_create(mySignalStart+77,9+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 9+ctx_index+1;
}
{
uint aux_create = 1;
...
{
std::string new_cmp_name = "dblLast";
MontgomeryDouble_11_create(mySignalStart+71,8+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[10] = 8+ctx_index+1;
}
{
std::string new_cmp_name = "m2e";
Montgomery2Edwards_14_create(mySignalStart+81,10+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[11] = 10+ctx_index+1;
}
{
std::string new_cmp_name = "cm2e";
Montgomery2Edwards_14_create(mySignalStart+67,7+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[12] = 7+ctx_index+1;
}
{
std::string new_cmp_name = "cAdd";
BabyAdd_17_create(mySignalStart+36,3+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[13] = 3+ctx_index+1;
}
{
PFrElement aux_dest = &lvar[1];
// load src
...
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 177
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 7);
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 7);
// end load src
...
{
std::string new_cmp_name = "segments[0]";
SegmentMulFix_28_create(mySignalStart+272,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "segments[1]";
SegmentMulFix_29_create(mySignalStart+9602,921+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 921+ctx_index+1;
}
{
std::string new_cmp_name = "m2e";
Montgomery2Edwards_14_create(mySignalStart+268,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "adders";
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId].defs[2].offset+map_accesses_aux[0]];
// load src
Fr_mul(&expaux[1],&lvar[5],&circuitConstants[62]); // line circom 260
...
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 2184;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
{
std::string new_cmp_name = "compConstant";
CompConstant_1_create(mySignalStart+7872,25+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 25+ctx_index+1;
}
{
std::string new_cmp_name = "bits2pointA";
Bits2Point_Strict_8_create(mySignalStart+2198,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "bits2pointR8";
Bits2Point_Strict_8_create(mySignalStart+5035,13+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 13+ctx_index+1;
}
{
std::string new_cmp_name = "hash";
Pedersen_18_create(mySignalStart+8433,33+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 33+ctx_index+1;
}
{
std::string new_cmp_name = "point2bitsH";
Point2Bits_Strict_19_create(mySignalStart+85683,7820+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 7820+ctx_index+1;
}
{
std::string new_cmp_name = "dbl1";
BabyDbl_20_create(mySignalStart+8391,27+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 27+ctx_index+1;
}
{
std::string new_cmp_name = "dbl2";
BabyDbl_20_create(mySignalStart+8405,29+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 29+ctx_index+1;
}
{
std::string new_cmp_name = "dbl3";
BabyDbl_20_create(mySignalStart+8419,31+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 31+ctx_index+1;
}
{
std::string new_cmp_name = "isZero";
IsZero_21_create(mySignalStart+67741,5827+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 5827+ctx_index+1;
}
{
std::string new_cmp_name = "mulAny";
EscalarMulAny_26_create(mySignalStart+67744,5828+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 5828+ctx_index+1;
}
{
std::string new_cmp_name = "addRight";
BabyAdd_17_create(mySignalStart+2188,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[10] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "mulFix";
EscalarMulFix_30_create(mySignalStart+75711,6859+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[11] = 6859+ctx_index+1;
}
{
PFrElement aux_dest = &lvar[1];
// load src
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 1928)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
{
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + 2182],&circuitConstants[1]); // line circom 50
}}
...
{
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + 2183],&circuitConstants[1]); // line circom 51
}}
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[57]); // line circom 57
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 1;
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 1416)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
{
PFrElement aux_dest = &signalValues[mySignalStart + 2184];
// load src
cmp_index_ref_load = 1;
cmp_index_ref_load = 1;
// end load src
...
{
PFrElement aux_dest = &signalValues[mySignalStart + 2185];
// load src
cmp_index_ref_load = 1;
cmp_index_ref_load = 1;
// end load src
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[57]); // line circom 67
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 2;
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 1672)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Bits2Point_Strict_8_run(mySubcomponents[cmp_index_ref],ctx);
...
{
PFrElement aux_dest = &signalValues[mySignalStart + 2186];
// load src
cmp_index_ref_load = 2;
cmp_index_ref_load = 2;
// end load src
...
{
PFrElement aux_dest = &signalValues[mySignalStart + 2187];
// load src
cmp_index_ref_load = 2;
cmp_index_ref_load = 2;
// end load src
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[57]); // line circom 77
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 3;
{
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[63]); // line circom 81
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 3;
{
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[57]); // line circom 109
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 9;
{
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[57]); // line circom 131
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 11;
{
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[49]); // line circom 31
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 0)];
// load src
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[65]); // line circom 31
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 0)];
// load src
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[66]); // line circom 31
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 0)];
// load src
...
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 0)];
// load src
Fr_shr(&expaux[1],&signalValues[mySignalStart + 32],&lvar[3]); // line circom 32
Fr_band(&expaux[0],&expaux[1],&circuitConstants[2]); // line circom 32
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
...
{
{{
Fr_eq(&expaux[0],&lvar[1],&signalValues[mySignalStart + 32]); // line circom 38
}}
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template/function " << myTemplateName << " line 38. " <<  "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
}
...
ctx->componentMemory[coffset].templateName = "ZUni";
ctx->componentMemory[coffset].signalStart = soffset;
...
EdDSAVerifier_31_create(mySignalStart+183,3+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 3+ctx_index+1;
}
{
uint aux_create = 1;
int aux_cmp_num = 7840+ctx_index+1;
uint csoffset = mySignalStart+89360;
uint aux_dimensions[1] = {2};
for (uint i = 0; i < 2; i++) {
std::string new_cmp_name = "pubKeyPartialsBits"+ctx->generate_position_array(aux_dimensions, 1, i);
Num2Bits_32_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+ i] = aux_cmp_num;
csoffset += 129 ;
aux_cmp_num += 1;
}
...
{
uint aux_create = 3;
int aux_cmp_num = 7842+ctx_index+1;
uint csoffset = mySignalStart+89618;
uint aux_dimensions[1] = {2};
for (uint i = 0; i < 2; i++) {
std::string new_cmp_name = "r8PartialsBits"+ctx->generate_position_array(aux_dimensions, 1, i);
Num2Bits_32_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+ i] = aux_cmp_num;
csoffset += 129 ;
aux_cmp_num += 1;
...
{
uint aux_create = 5;
int aux_cmp_num = 7845+ctx_index+1;
uint csoffset = mySignalStart+90005;
uint aux_dimensions[1] = {2};
for (uint i = 0; i < 2; i++) {
std::string new_cmp_name = "sPartialsBits"+ctx->generate_position_array(aux_dimensions, 1, i);
Num2Bits_32_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+ i] = aux_cmp_num;
csoffset += 129 ;
aux_cmp_num += 1;
...
{
std::string new_cmp_name = "nameBits";
Num2Bits_33_create(mySignalStart+89111,7839+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 7839+ctx_index+1;
}
{
std::string new_cmp_name = "dayOfBirthBits";
Num2Bits_34_create(mySignalStart+149,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "monthOfBirthBits";
Num2Bits_34_create(mySignalStart+89077,7837+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 7837+ctx_index+1;
}
{
std::string new_cmp_name = "yearOfBirthBits";
Num2Bits_35_create(mySignalStart+90674,7850+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[10] = 7850+ctx_index+1;
}
{
std::string new_cmp_name = "schoolBits";
Num2Bits_33_create(mySignalStart+90263,7847+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[11] = 7847+ctx_index+1;
}
{
std::string new_cmp_name = "yearGraduationBits";
Num2Bits_35_create(mySignalStart+90641,7849+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[12] = 7849+ctx_index+1;
}
{
std::string new_cmp_name = "majorBits";
Num2Bits_33_create(mySignalStart+88699,7835+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[13] = 7835+ctx_index+1;
}
{
std::string new_cmp_name = "classificationBits";
Num2Bits_32_create(mySignalStart+20,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[14] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "modeOfStudyBits";
Num2Bits_32_create(mySignalStart+88948,7836+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[15] = 7836+ctx_index+1;
}
{
std::string new_cmp_name = "serialNumberBits";
Num2Bits_32_create(mySignalStart+90512,7848+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[16] = 7848+ctx_index+1;
}
{
std::string new_cmp_name = "referenceNumberBits";
Num2Bits_32_create(mySignalStart+89876,7844+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[17] = 7844+ctx_index+1;
}
{
std::string new_cmp_name = "dayOfIssueBits";
Num2Bits_34_create(mySignalStart+166,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[18] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "monthOfIssueBits";
Num2Bits_34_create(mySignalStart+89094,7838+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[19] = 7838+ctx_index+1;
}
{
std::string new_cmp_name = "yearOfIssueBits";
Num2Bits_35_create(mySignalStart+90707,7851+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[20] = 7851+ctx_index+1;
}
{
PFrElement aux_dest = &lvar[0];
// load src
...
Fr_lt(&expaux[0],&lvar[16],&circuitConstants[6]); // line circom 45
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[16])) + 1);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 128];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[16])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Num2Bits_32_run(mySubcomponents[cmp_index_ref],ctx);

}
}
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[16])) + 3);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 128];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[16])) + 3)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Num2Bits_32_run(mySubcomponents[cmp_index_ref],ctx);
...
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[16])) + 5);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 128];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[16])) + 5)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Num2Bits_32_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[16];
// load src
Fr_add(&expaux[0],&lvar[16],&circuitConstants[2]); // line circom 45
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[16],&circuitConstants[6]); // line circom 45
...
Fr_lt(&expaux[0],&lvar[16],&circuitConstants[49]); // line circom 55
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * Fr_toInt(&lvar[16])) + 1416)];
// load src
cmp_index_ref_load = 1;
cmp_index_ref_load = 1;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + ((1 * Fr_toInt(&lvar[16])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[16]) + 128)) + 1416)];
// load src
cmp_index_ref_load = 2;
cmp_index_ref_load = 2;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + ((1 * Fr_toInt(&lvar[16])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * Fr_toInt(&lvar[16])) + 1672)];
// load src
cmp_index_ref_load = 3;
cmp_index_ref_load = 3;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[3]].signalStart + ((1 * Fr_toInt(&lvar[16])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[16]) + 128)) + 1672)];
// load src
cmp_index_ref_load = 4;
cmp_index_ref_load = 4;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[4]].signalStart + ((1 * Fr_toInt(&lvar[16])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * Fr_toInt(&lvar[16])) + 1928)];
// load src
cmp_index_ref_load = 5;
cmp_index_ref_load = 5;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[5]].signalStart + ((1 * Fr_toInt(&lvar[16])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[16]) + 128)) + 1928)];
// load src
cmp_index_ref_load = 6;
cmp_index_ref_load = 6;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[6]].signalStart + ((1 * Fr_toInt(&lvar[16])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[16];
// load src
Fr_add(&expaux[0],&lvar[16],&circuitConstants[2]); // line circom 55
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[16],&circuitConstants[49]); // line circom 55
...
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[65]); // line circom 85
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * Fr_toInt(&lvar[17])) + 0)];
// load src
cmp_index_ref_load = 7;
cmp_index_ref_load = 7;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[7]].signalStart + ((1 * Fr_toInt(&lvar[17])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[17];
// load src
Fr_add(&expaux[0],&lvar[17],&circuitConstants[2]); // line circom 85
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[65]); // line circom 85
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Num2Bits_34_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &lvar[17];
// load src
...
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[66]); // line circom 92
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[17]) + 248)) + 0)];
// load src
cmp_index_ref_load = 8;
cmp_index_ref_load = 8;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[8]].signalStart + ((1 * Fr_toInt(&lvar[17])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[17];
// load src
Fr_add(&expaux[0],&lvar[17],&circuitConstants[2]); // line circom 92
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[66]); // line circom 92
...
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[66]); // line circom 99
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[17]) + 264)) + 0)];
// load src
cmp_index_ref_load = 9;
cmp_index_ref_load = 9;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[9]].signalStart + ((1 * Fr_toInt(&lvar[17])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[17];
// load src
Fr_add(&expaux[0],&lvar[17],&circuitConstants[2]); // line circom 99
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[66]); // line circom 99
...
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[22]); // line circom 106
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[17]) + 280)) + 0)];
// load src
cmp_index_ref_load = 10;
cmp_index_ref_load = 10;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[10]].signalStart + ((1 * Fr_toInt(&lvar[17])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[17];
// load src
Fr_add(&expaux[0],&lvar[17],&circuitConstants[2]); // line circom 106
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[22]); // line circom 106
...
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[65]); // line circom 113
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[17]) + 312)) + 0)];
// load src
cmp_index_ref_load = 11;
cmp_index_ref_load = 11;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[11]].signalStart + ((1 * Fr_toInt(&lvar[17])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[17];
// load src
Fr_add(&expaux[0],&lvar[17],&circuitConstants[2]); // line circom 113
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[65]); // line circom 113
...
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[22]); // line circom 120
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[17]) + 560)) + 0)];
// load src
cmp_index_ref_load = 12;
cmp_index_ref_load = 12;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[12]].signalStart + ((1 * Fr_toInt(&lvar[17])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[17];
// load src
Fr_add(&expaux[0],&lvar[17],&circuitConstants[2]); // line circom 120
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[22]); // line circom 120
...
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[65]); // line circom 127
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[17]) + 592)) + 0)];
// load src
cmp_index_ref_load = 13;
cmp_index_ref_load = 13;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[13]].signalStart + ((1 * Fr_toInt(&lvar[17])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[17];
// load src
Fr_add(&expaux[0],&lvar[17],&circuitConstants[2]); // line circom 127
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[65]); // line circom 127
...
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[49]); // line circom 134
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[17]) + 840)) + 0)];
// load src
cmp_index_ref_load = 14;
cmp_index_ref_load = 14;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[14]].signalStart + ((1 * Fr_toInt(&lvar[17])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[17];
// load src
Fr_add(&expaux[0],&lvar[17],&circuitConstants[2]); // line circom 134
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[49]); // line circom 134
...
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[49]); // line circom 141
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[17]) + 968)) + 0)];
// load src
cmp_index_ref_load = 15;
cmp_index_ref_load = 15;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[15]].signalStart + ((1 * Fr_toInt(&lvar[17])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[17];
// load src
Fr_add(&expaux[0],&lvar[17],&circuitConstants[2]); // line circom 141
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[49]); // line circom 141
...
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[49]); // line circom 148
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[17]) + 1096)) + 0)];
// load src
cmp_index_ref_load = 16;
cmp_index_ref_load = 16;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[16]].signalStart + ((1 * Fr_toInt(&lvar[17])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[17];
// load src
Fr_add(&expaux[0],&lvar[17],&circuitConstants[2]); // line circom 148
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[49]); // line circom 148
...
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[49]); // line circom 155
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[17]) + 1224)) + 0)];
// load src
cmp_index_ref_load = 17;
cmp_index_ref_load = 17;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[17]].signalStart + ((1 * Fr_toInt(&lvar[17])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[17];
// load src
Fr_add(&expaux[0],&lvar[17],&circuitConstants[2]); // line circom 155
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[49]); // line circom 155
...
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[66]); // line circom 162
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[17]) + 1352)) + 0)];
// load src
cmp_index_ref_load = 18;
cmp_index_ref_load = 18;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[18]].signalStart + ((1 * Fr_toInt(&lvar[17])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[17];
// load src
Fr_add(&expaux[0],&lvar[17],&circuitConstants[2]); // line circom 162
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[66]); // line circom 162
...
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[66]); // line circom 169
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[17]) + 1368)) + 0)];
// load src
cmp_index_ref_load = 19;
cmp_index_ref_load = 19;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[19]].signalStart + ((1 * Fr_toInt(&lvar[17])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[17];
// load src
Fr_add(&expaux[0],&lvar[17],&circuitConstants[2]); // line circom 169
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[66]); // line circom 169
...
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[22]); // line circom 176
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[17]) + 1384)) + 0)];
// load src
cmp_index_ref_load = 20;
cmp_index_ref_load = 20;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[20]].signalStart + ((1 * Fr_toInt(&lvar[17])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAVerifier_31_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[17];
// load src
Fr_add(&expaux[0],&lvar[17],&circuitConstants[2]); // line circom 176
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[22]); // line circom 176
...
{
{{
Fr_eq(&expaux[0],&circuitConstants[63],&circuitConstants[63]); // line circom 182
}}
