...
void Num2Bits_36_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Num2Bits_36_run(uint ctx_index,Circom_CalcWit* ctx);
void ZUni_37_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void ZUni_37_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_size_of_constants() {return 83;}
...
// load src
Fr_pow(&expaux[0],&lvar[0],&circuitConstants[82]); // line circom 40
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_add(&expaux[2],&circuitConstants[82],&circuitConstants[2]); // line circom 41
...
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 0)];
// load src
Fr_shr(&expaux[1],&signalValues[mySignalStart + 352],&lvar[3]); // line circom 32
Fr_band(&expaux[0],&expaux[1],&circuitConstants[2]); // line circom 32
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
...
{
{{
Fr_eq(&expaux[0],&lvar[1],&signalValues[mySignalStart + 352]); // line circom 38
}}
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template/function " << myTemplateName << " line 38. " <<  "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
}
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[67]); // line circom 31
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 0)];
// load src
...
uint csoffset = mySignalStart+89568;
...
uint csoffset = mySignalStart+89826;
uint aux_dimensions[1] = {2};
for (uint i = 0; i < 2; i++) {
...
uint csoffset = mySignalStart+90213;
uint aux_dimensions[1] = {2};
for (uint i = 0; i < 2; i++) {
...
Num2Bits_33_create(mySignalStart+89215,7839+ctx_index+1,ctx,new_cmp_name,myId);
...
Num2Bits_34_create(mySignalStart+89181,7837+ctx_index+1,ctx,new_cmp_name,myId);
...
{
std::string new_cmp_name = "schoolCodeBits";
Num2Bits_36_create(mySignalStart+90471,7847+ctx_index+1,ctx,new_cmp_name,myId);
...
Num2Bits_32_create(mySignalStart+89052,7836+ctx_index+1,ctx,new_cmp_name,myId);
...
Num2Bits_32_create(mySignalStart+90084,7844+ctx_index+1,ctx,new_cmp_name,myId);
...
Num2Bits_34_create(mySignalStart+89198,7838+ctx_index+1,ctx,new_cmp_name,myId);
...
uint cmp_index_ref = 7;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 352];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + 7]);
}
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[17]) + 352)) + 0)];
// load src
cmp_index_ref_load = 8;
cmp_index_ref_load = 8;
// end load src
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[17]) + 368)) + 0)];
// load src
cmp_index_ref_load = 9;
cmp_index_ref_load = 9;
// end load src
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[17]) + 384)) + 0)];
// load src
cmp_index_ref_load = 10;
cmp_index_ref_load = 10;
// end load src
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Num2Bits_36_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &lvar[17];
// load src
...
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[67]); // line circom 113
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[17]) + 416)) + 0)];
// load src
cmp_index_ref_load = 11;
cmp_index_ref_load = 11;
// end load src
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[17]) + 456)) + 0)];
// load src
cmp_index_ref_load = 12;
cmp_index_ref_load = 12;
// end load src
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * (Fr_toInt(&lvar[17]) + 488)) + 0)];
// load src
cmp_index_ref_load = 13;
cmp_index_ref_load = 13;
// end load src
